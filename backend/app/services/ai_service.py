...
COMMODITY_KEYWORDS = {
    ...
    "Toor Dal": ["toor dal", "toor daal", "toor", "tur", "tur dal", "tur daal", "arhar", "arhar dal", "ತೊಗರಿ ಬೇಳೆ", "ತೊಗರಿ", "तुअर", "अरहर", "துவரம் பருப்பு", "pigeon pea"],
    "Masur": ["masoor", "masoor daal", "masoor dal", "masur", "masur dal", "masur daal", "मसूर", "मसूर दाल", "ಮಸೂರ್ ಬೇಳೆ"],
    "Moong": ["moong", "mung", "moong dal", "moong daal", "mung dal", "green gram", "मूंग", "मूंग दाल", "ಹೆಸರು ಬೇಳೆ"],
    "Urad": ["urad", "urad dal", "urad daal", "black gram", "उड़द", "उड़द दाल", "ಉದ್ದಿನ ಬೇಳೆ"],
    "Gram (Chana)": ["gram", "chana", "chana dal", "chana daal", "chickpea", "चना", "चना दाल", "ಕಡಲೆ", "ಕಡಲೆ ಬೇಳೆ", "கொண்டைக்கடலை"],
    ...
    "Mustard": ["mustard", "sarson", "सरसों", "ಸಾಸಿವೆ", "கடுगु"],
